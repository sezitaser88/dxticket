(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("reflect-metadata"), require("inversify"), require("emittery"), require("sanitize-html"), require("@xmldom/xmldom"), require("cookie")) : typeof define === "function" && define.amd ? define([ "exports", "reflect-metadata", "inversify", "emittery", "sanitize-html", "@xmldom/xmldom", "cookie" ], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, 
    factory(global.BloomreachSpaSdk = {}, null, global.inversify, global.emiterry, global.sanitizeHtml, global.xmldom, global.cookie));
})(this, (function(exports, reflectMetadata, inversify, emittery, sanitizeHtml, xmldom, cookie) {
    "use strict";
    ...
    var sanitizeHtml__default = _interopDefaultLegacy(sanitizeHtml);
    ...
    CmsImpl = __decorate([ inversify.injectable(), __param(0, inversify.inject(RpcClientService)), __param(1, inversify.inject(RpcServerService)), __param(2, inversify.inject(EventBusService$1)), __param(2, inversify.optional()), __param(3, inversify.inject(Logger)), __param(3, inversify.optional()), __metadata("design:paramtypes", [ Object, Object, Object, Logger ]) ], CmsImpl);
    ...
    Cms14Impl = __decorate([ inversify.injectable(), __param(0, inversify.inject(EventBusService$1)), __param(0, inversify.optional()), __param(1, inversify.inject(Logger)), __param(1, inversify.optional()), __metadata("design:paramtypes", [ Object, Logger ]) ], Cms14Impl);
   ...
   */    function getContainerItemContent(component, page) {
    ...
    ContainerItemImpl$1 = __decorate([ inversify.injectable(), __param(0, inversify.inject(ComponentModelToken)), __param(1, inversify.inject(LinkFactory)), __param(2, inversify.inject(MetaCollectionFactory)), __param(3, inversify.inject(EventBusService)), __param(3, inversify.optional()), __param(4, inversify.inject(Logger)), __param(4, inversify.optional()), __metadata("design:paramtypes", [ Object, LinkFactory, Function, Object, Logger ]) ], ContainerItemImpl$1);
    /**
   ...
   */    function isContainerItem$2(value) {
    ...
    ContainerItemImpl = __decorate([ inversify.injectable(), __param(0, inversify.inject(ComponentModelToken)), __param(1, inversify.inject(MetaCollectionFactory)), __param(2, inversify.inject(UrlBuilderService)), __param(3, inversify.inject(EventBusService)), __param(3, inversify.optional()), __param(4, inversify.inject(Logger)), __param(4, inversify.optional()), __metadata("design:paramtypes", [ Object, Function, Object, Object, Logger ]) ], ContainerItemImpl);
    /**
   * Checks whether a value is a page container item.
   * @param value The value to check.
   ...
   */    let ComponentFactory$1 = class ComponentFactory extends SimpleFactory {
    ...
    let PageImpl$1 = class PageImpl {
        ...
        sanitize(content) {
            return sanitizeHtml__default["default"](content, {
                allowedAttributes: {
   ...
   */    let Spa = class Spa {
    ...
    Spa = __decorate([ inversify.injectable(), __param(0, inversify.inject(ApiService)), __param(1, inversify.inject(PageFactory)), __param(2, inversify.inject(EventBusService$1)), __param(2, inversify.optional()), __param(3, inversify.inject(EventBusService)), __param(3, inversify.optional()), __param(4, inversify.inject(Logger)), __param(4, inversify.optional()), __metadata("design:paramtypes", [ Object, Function, Object, Object, Logger ]) ], Spa);
    function SpaModule() {
        return new inversify.ContainerModule((bind => {
